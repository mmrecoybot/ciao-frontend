...
export default function ChangePasswordForm({ dictionary }) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        >
          {dictionary.navItems.current_password}
        </label>
        <input
          id="currentPassword"
          type="password"
      ...
      <div className="space-y-2">
        <label
          ...
          className="block text-sm font-medium text-gray-700"
        >
          {dictionary.navItems.new_password}
        </label>
        <input
          id="newPassword"
          type="password"
      ...
      <div className="space-y-2">
        <label
          ...
          className="block text-sm font-medium text-gray-700"
        >
          {dictionary.navItems.confirm_new_password}
        </label>
        <input
      ...
      >
        {isSubmitting
          ? dictionary.navItems.changing_password
