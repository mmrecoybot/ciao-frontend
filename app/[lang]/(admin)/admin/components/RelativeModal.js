...
export default function RelativeModal({ setShowForm, title, children }) {
  ...
  return (
    ...
    >
      <div
        className="w-[50rem] bg-background animate-scale rounded-md shadow-xl max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <header className="modal-header flex justify-between rounded-t-md items-center p-4 bg-emerald-100 text-gray-600 sticky top-0 z-10">
